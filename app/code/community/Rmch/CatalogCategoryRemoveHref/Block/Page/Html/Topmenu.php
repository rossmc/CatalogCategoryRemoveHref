<?php
class Rmch_CatalogCategoryRemoveHref_Block_Page_Html_Topmenu extends Mage_Page_Block_Html_Topmenu
{
    /**
    ...
    protected function _getHtml(Varien_Data_Tree_Node $menuTree, $childrenWrapClass)
    {
        ...
        foreach ($children as $child) {
            ...
            if ($child->getRemoveHref()) {
                ...
                $outermostClass .= ' no-hover';  // also adding a css class to help set css on menu items without a href
            } else {
            ...
            $html .= '<a href="' . $menuItemHref . '" ' . $outermostClassCode . '><span>'  // RMCH: including $menuItemHref here
